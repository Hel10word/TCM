...
public class MysqlMappingTool implements MappingTool {
    ...
    static {
        ...
        mappingMap.put("TEXT", TCMDataTypeEnum.STRING);
        mappingMap.put("TINYBLOB", TCMDataTypeEnum.BYTES);
        mappingMap.put("TINYTEXT", TCMDataTypeEnum.STRING);
        mappingMap.put("MEDIUMBLOB", TCMDataTypeEnum.BYTES);
        mappingMap.put("MEDIUMTEXT", TCMDataTypeEnum.STRING);
        mappingMap.put("LONGBLOB", TCMDataTypeEnum.BYTES);
        mappingMap.put("LONGTEXT", TCMDataTypeEnum.STRING);
        mappingMap.put("ENUM", TCMDataTypeEnum.STRING);
        mappingMap.put("SET", TCMDataTypeEnum.STRING);
    ...
    public Table createSourceMappingTable(Table table) {
        ...
        for (Column column : columns){
            ...
            if("TINYINT".equalsIgnoreCase(colName) && column.getCharacterMaximumPosition() == 1)
    ...
    public String getCreateTableSQL(Table table) {
        ...
        for(Column column : columns){
            ...
            if (TCMDataTypeEnum.INT8.equals(tcmDataTypeEnum)){
            ...
            } else if (TCMDataTypeEnum.BOOLEAN.equals(tcmDataTypeEnum)){
                // Nothing to do
                // Default TINYINT(1)
            } else if (
                ...
                /**
                 * the VARCHAR or VARBINARY sometimes it cannot be set to (65532) , the field size is limited and many aspects.
                ...
                if(characterMaximumPosition != null){
                    if(characterMaximumPosition >= 0 && characterMaximumPosition <= 65535)
