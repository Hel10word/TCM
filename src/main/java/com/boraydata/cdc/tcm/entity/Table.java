...
//                .append("\tTableName:").append(this.tableName).append("\n")
    ...
    public String outInfo(){
        return String.format("DataSourceEnum:%-20s OriginalDataSourceEnum:%-20s CatalogName:%-20s SchemaName:%-20s TableName:%-20s ColumnCount:%-10s PrimaryKeyName:%-20s PrimaryKeys:%-20s",
